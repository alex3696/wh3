...
COPY __cls00 FROM '/home/pi/tmp/__cls00.csv'  WITH CSV HEADER DELIMITER ';' ENCODING 'WIN866' ;
...
COPY __cls01 FROM '/home/pi/tmp/__cls01.csv'  WITH CSV HEADER DELIMITER ';' ENCODING 'WIN866' ;
...
COPY __cls FROM '/home/pi/tmp/__cls.csv'  WITH CSV HEADER DELIMITER ';' ENCODING 'WIN866' ;
...
COPY __obj FROM '/home/pi/tmp/__obj.csv'  WITH CSV HEADER DELIMITER ';' ENCODING 'WIN866' ;
...
COPY __hist FROM '/home/pi/tmp/__hist.csv'  WITH CSV HEADER DELIMITER ';' ENCODING 'WIN866' ;
...
(
 ...
 COPY __departament FROM '/home/pi/tmp/__departament.csv'  WITH CSV HEADER DELIMITER ';' ENCODING 'WIN866' ;
-------------------------------------------------------------------------------
PRINT '';
...
(
 ...
 COPY __worker FROM '/home/pi/tmp/__worker.csv'  WITH CSV HEADER DELIMITER ';' ENCODING 'WIN866' ;
