#ifndef __MCLSOBJNUM_H
#define __MCLSOBJNUM_H
...
//-------------------------------------------------------------------------
class MClsObjNum : public TModelData<rec::ClsObjNum>
{
public:
	MClsObjNum(const char option
...
//-------------------------------------------------------------------------
class MClsObjNumArray : public IModel
{
public:
	typedef  MClsObjNum		T_Item;

	MClsObjNumArray(const char option
		= ModelOption::EnableParentNotify
		| ModelOption::EnableNotifyFromChild);
