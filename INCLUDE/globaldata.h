...
{
	msNull = 0,
	msCreated,	//NEW созданна€(нова€) модель
	msExist,	//модель, данные которой синхронизированы с хранилищем
	msUpdated,	//измененна€ модель
	msDeleted,	//удаленна€ модель
...
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
/** менеджер данных приложени€ 
¬се основные действи€ и комманды изменени€ данных выполн€ем через него
*/
class whDataMgr
{
private:
