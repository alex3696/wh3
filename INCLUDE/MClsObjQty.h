#ifndef __MCLSOBJQTY_H
#define __MCLSOBJQTY_H
...
//-------------------------------------------------------------------------
class MClsObjQty : public TModelData<rec::ClsObjQty>
{
public:
	MClsObjQty(const char option
...
//-------------------------------------------------------------------------
class MClsObjQtyArray : public IModel
{
public:
	typedef  MClsObjQty		T_Item;

	MClsObjQtyArray(const char option
		= ModelOption::EnableParentNotify
		| ModelOption::EnableNotifyFromChild);
